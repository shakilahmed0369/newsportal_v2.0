          ...
          <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tags" type="text" class="form-control" id="meta_tags" data-role="tagsinput">
                        @error('tags')
                            <span class="text-danger">{{ $message }} </span>
                        @enderror
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="preview">
                    ...
                    <img style="background-image: url(https://via.placeholder.com/310x230); display:block; height:230px; width:100%; object-fit:cover" class="img-fluid" id="blah" />
                </div>
                ...
                <div class="custom-control custom-switch">
                    <input value="1" name="featured" type="checkbox" class="custom-control-input" id="customswitch1">
