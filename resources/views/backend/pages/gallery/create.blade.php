...
<div class="card">
  ...
  <div class="card-body">
      <form id="from" action="{{ route('admin.gallery.store') }}" method="post" enctype="multipart/form-data">
        @csrf
      <div class="col-md-8 offset-2">
            <div class="preview">
                <label for="tags">Image</label> <br>
                
                <img style="background-image: url(https://via.placeholder.com/650x350?text=photo) ; display:block; height:350px; width:100%; object-fit:cover" class="img-fluid" id="blah"/>
            </div>
